...
<head>
  ...
  <style>
    /* FIX LAYOUT MEPET NAVBAR */
    .app-main-content {
        padding-top: 70px; /* Memberi jarak dari navbar fixed */
        min-height: calc(100vh - 60px); /* Memastikan footer ada di bawah */
        padding-bottom: 30px;
        position: relative;
        z-index: 1;
    }
    
    /* Memastikan konten di dalam yield rapi */
    .padding {
        padding: 1.5rem;
    }
  </style>
...
<body>
        ...
        <div class="app-footer">
          <div class="p-2 text-xs">
            <div class="pull-right text-muted py-1">
              ...
              <span class="hidden-xs-down">Code with love by The Devantara</span>
  ...
  <script>
    $(document).ready(function() {
      ...
      // Initialize DataTable if #example exists
      if($('#example').length){
